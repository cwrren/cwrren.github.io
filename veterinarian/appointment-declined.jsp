<%-- 
    Document   : appointment-pending
    Created on : Apr 8, 2021, 4:13:56 PM
    Author     : cwrre
--%>
...
<%
            ...
            List<Appointment> allAppointment = appointmentDao.retrieveDeclinedAppointment();
%>
                                  ...
                                  <%
                                        for (int i = 0; i<allAppointment.size(); i++){
                                          ...
                                          out.println("<td><a href=../ApproveAppointmentServlet?aptID="
                                                  ...
                                                  + "('Are you sure you want to approve?')\">Approve</a>"
                                                  + "</td>");
                                          out.println("</tr>");
                                      }
                                    %>
