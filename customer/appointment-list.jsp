<%-- 
    ...
    Created on : Apr 3, 2021, 1:18:36 AM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.*"%>
<%@page import="java.sql.*, vetclinic.Appointment"%>
                                ...
                                <tbody>
                                  <%
                                        for (int i = 0; i<allAppointment.size(); i++){
                                          ...
                                          out.println("<td>"+slotDao.retrieveOneSlot(allAppointment.get(i).getSlotID()).getSlotDate()+"  "+slotDao.retrieveOneSlot(allAppointment.get(i).getSlotID()).getSlotTime()+"</td>");
                                          out.println("<td>"+petDao.retrieveOnePet(allAppointment.get(i).getPetID()).getPetName()+"</td>");
