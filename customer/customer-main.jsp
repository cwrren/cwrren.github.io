<%-- 
    Document   : admin-main
    Created on : May 24, 2020, 3:33:04 PM
    Author     : Wei Ren
--%>

<%@page import="vetclinic.Appointment"%>
<%@page import="vetclinic.Pet"%>
...
<%
            ...
            List<Appointment> allAppointment = appointmentDao.retrieveAppointment(custid);
%>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-warning card-header-icon">
                    ...
                    <p class="card-category">Pets Number</p>
                    <h3 class="card-title"><%=allPet.size()%></h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons text-warning">warning</i>
                      <a href="cust-pet-list.jsp" class="warning-link">Check My Pets...</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    ...
                    <p class="card-category">Appointment Made</p>
                    <h3 class="card-title"><%=allAppointment.size()%></h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">local_offer</i> 
                      <a href="appointment-list.jsp" class="warning-link">Check Your Appointment...</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <p class="card-category">Incomplete Payment</p>
                    <h3 class="card-title">RM 0</h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">date_range</i> Pay In 24 Hours
                    </div>
                  </div>
                </div>
              </div>
