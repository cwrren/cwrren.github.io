<%-- 
    Document   : treatment-list
    Created on : Apr 6, 2021, 11:20:43 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.*"%>
<%@page import="java.sql.*, vetclinic.Treatment"%>
<jsp:useBean id="database" class="vetclinic.DBConnection" scope="request"/>
<jsp:useBean id="treatmentDao" class="vetclinic.TreatmentDAO" scope="request"/>
<!DOCTYPE html>
<html lang="en">
...
<%
            ...
            List<Treatment> allTreatment = treatmentDao.retrieveTreatment(custid);
%>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Treatment Table</h4>
                      </div>
                      <div class="card-body">
                                ...
                                <tbody>
                                  <%
                                        for (int i = 0; i<allTreatment.size(); i++){
                                          ...
                                          out.println("<tr>");
                                          out.println("<td>"+allTreatment.get(i).getTreatID() + "</td>");
                                          out.println("<td>"+allTreatment.get(i).getAptID()+"</td>");
                                          out.println("<td>"+allTreatment.get(i).getVetID()+"</td>");
                                          out.println("<td>"+allTreatment.get(i).getDisease()+"</td>");
                                          out.println("<td>"+allTreatment.get(i).getService()+"</td>");
                                          out.println("<td>"+allTreatment.get(i).getStatus()+"</td>");
                                          out.println("<td>"+allTreatment.get(i).getPayID()+"</td>");
                                          out.println("</tr>");
                                      }
                                    %>
                                </tbody>
