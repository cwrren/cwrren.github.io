<%-- 
    Document   : process-update-vet1
    Created on : Mar 31, 2021, 10:44:38 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.sql.*, vetclinic.DBConnection, vetclinic.VeterinarianDAO"%>
<%@page import="vetclinic.Veterinarian"%>
<!DOCTYPE html>
<html lang="en">
...
<%
        ...
        Veterinarian veterinarian = veterinarianDao.retrieveOneVeterinarian(vetID);
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Veterinarian</a>
          </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Veterinarian</h4>
                      </div>
                      <div class="card-body ">
                          <form role="form" action="../UpdateVetServlet" method="post">
                            <input type="hidden" name="hidid" value="<%=veterinarian.getVetID()%>"/>
                            <div class="row">
                              ...
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  <label for="id" class="md-label-floating">Veterinarian ID</label>
                                  <input type="text" class="form-control" disabled="" id="id" placeholder="id" value="<%=veterinarian.getVetID()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="email" class="form-control" placeholder="123@gmail.com" value="<%=veterinarian.getVetEmail()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Muhammad Ali Bin Abu" value="<%=veterinarian.getVetName()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                   <input type="text" name="phone" class="form-control" placeholder="0123456789" value="<%=veterinarian.getVetPhoneNo()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Password</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="password" class="form-control" placeholder="Password" value="<%=veterinarian.getVetPassword()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Address</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="address" class="form-control" placeholder="Address" value="<%=veterinarian.getVetAddress()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Responsibility</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="responsibility" class="form-control" placeholder="Responsibility" value="<%=veterinarian.getResponsibility()%>">
                                </div>
                              </div>
                            </div>
