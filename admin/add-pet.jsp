<%-- 
    Document   : add-pet1
    Created on : Mar 30, 2021, 5:04:52 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.sql.*, vetclinic.DBConnection"%>
<%@page import="java.io.*, java.util.List, vetclinic.Pet, Customer.Customer, Customer.CustomerDAO"%>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body ">
                          <form role="form" action="../AddPetServlet" method="post">
                            <div class="row">
                              ...
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  <label for="id" class="md-label-floating">Pet ID</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Marry" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Customer</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <select class="selectpicker" name="custid" data-style="select-with-transition" title="Choose Customer" data-size="<%allCustomer.size();%>">
                                  <%
                                      for (int i = 0; i<allCustomer.size(); i++){
                                          out.println("<option value='"+allCustomer.get(i).getCustID()+"'>"+allCustomer.get(i).getCustID()+" "+allCustomer.get(i).getCustName()+"</option>");
                                      }
                                  %>
                                  </select>
                                </div>
