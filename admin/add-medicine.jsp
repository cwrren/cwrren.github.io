<%-- 
    Document   : add-medicine1
    Created on : Mar 29, 2021, 3:18:42 PM
    Author     : cwrre
--%>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header card-header-primary card-header-icon">
                        ...
                        <div class="card-body ">
                          <form role="form" action="../AddMedicineServlet" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Paracetamol" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                  <div class="form-group">
                                    <input type="text" name="quantity" class="form-control" placeholder="50" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Price</label>
                                <div class="col-sm-2">
                                  <div class="form-group">
                                    <input type="text" name="price" class="form-control" placeholder="10.99" value="">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Expiry Date</label>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <input type="date" name="expiry" class="form-control datepicker" value="">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Last Update</label>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <input type="date" name="update" class="form-control datepicker" value="">
                                  </div>
                              </div>
                            </div>
