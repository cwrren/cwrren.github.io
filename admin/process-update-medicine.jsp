<%-- 
    Document   : process-update-medicine1
    Created on : Mar 30, 2021, 4:40:09 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.sql.*, vetclinic.DBConnection, vetclinic.MedicineDAO"%>
<%@page import="vetclinic.Medicine"%>
<!DOCTYPE html>
<html lang="en">
...
<%
        ...
        Medicine medicine = medicineDao.retrieveOneMedicine(medID);
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Medicine</a>
          </div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header card-header-primary card-header-icon">
                        ...
                        <div class="card-body ">
                          <form role="form" action="../UpdateMedicineServlet" method="post">
                            <input type="hidden" name="hidid" value="<%=medicine.getMedID()%>"/>
                            <div class="row">
                              ...
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  <label for="id" class="md-label-floating">Medicine ID</label>
                                  <input type="text" name="id" class="form-control" disabled="" id="id" placeholder="id" value="<%=medicine.getMedID()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Paracetamol" value="<%=medicine.getMedName()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                  <div class="form-group">
                                    <input type="text" name="quantity" class="form-control" placeholder="50" value="<%=medicine.getMedQuantity()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Price</label>
                                <div class="col-sm-2">
                                  <div class="form-group">
                                    <input type="text" name="price" class="form-control" placeholder="10.99" value="<%=medicine.getMedPrice()%>">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Expiry Date</label>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <input type="date" name="expiry" class="form-control datepicker" value="<%=medicine.getMedExpiryDate()%>">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Last Update</label>
                                <div class="col-md-2">
                                  <div class="form-group">
                                    <input type="date" name="update" class="form-control datepicker" value="<%=medicine.getLastUpdate()%>">
                                  </div>
                              </div>
                            </div>
