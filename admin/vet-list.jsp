<%-- 
    Document   : vet-list1
    Created on : Mar 31, 2021, 12:30:10 AM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.sql.*, vetclinic.Veterinarian, java.util.List"%>
<jsp:useBean id="database" class="vetclinic.DBConnection" scope="request"/>
<jsp:useBean id="veterinarianDao" class="vetclinic.VeterinarianDAO" scope="request"/>
<!DOCTYPE html>
<html lang="en">
...
<%
            ...
            List<Veterinarian> allVeterinarian = veterinarianDao.retrieveAllVeterinarian();
%>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header card-header-primary card-header-icon">
                        ...
                        <h4 class="card-title">Veterinarian Table</h4>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table"  style="table-layout: fixed; width: 100%">
                                ...
                                <tbody>
                                  <%
                                        for (int i = 0; i<allVeterinarian.size(); i++){

                                          out.println("<tr>");
                                          out.println("<td>"+allVeterinarian.get(i).getVetID() + "</td>");
                                          out.println("<td>"+allVeterinarian.get(i).getVetName()+"</td>");
                                          out.println("<td> +60 "+allVeterinarian.get(i).getVetPhoneNo()+"</td>");
                                          out.println("<td>"+allVeterinarian.get(i).getVetEmail()+"</td>");
                                          out.println("<td>"+allVeterinarian.get(i).getVetPassword()+"</td>");
                                          out.println("<td>"+allVeterinarian.get(i).getVetAddress()+"</td>");
                                          out.println("<td>"+allVeterinarian.get(i).getResponsibility()+"</td>");
                                          out.println("<td><a href=process-update-vet.jsp?vetID="
                                                  + allVeterinarian.get(i).getVetID() + ">Update</a>"
                                                  + "i" + "<a href=../DeleteVetServlet?vetID="
                                                  + allVeterinarian.get(i).getVetID() + " onclick=\"return confirm"
                                  ...
                                  <tr>
                                    <td colspan="2" class="text-left">
                                        <a href="add-vet.jsp"><button type="button" class="btn btn-info btn-round">Add Veterinarian <i class="material-icons">keyboard_arrow_right</i></button></a>
                                    </td>
                                  </tr>
                                </tbody>
                          </table>
