<%-- 
    Document   : process-update-customer1
    Created on : Mar 28, 2021, 11:13:21 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.sql.*, vetclinic.DBConnection, Customer.CustomerDAO"%>
<%@page import="Customer.Customer"%>
<%@page import="java.io.*, java.util.List, vetclinic.Pet"%>
...
<%
        ...
        Customer customer = customerDao.retrieveOneCustomer(custID);
        List<Pet> allPet = petDao.retrieveAllPet();
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Customer</a>
          </div>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                          <form role="form" action="../UpdateCustomerServlet" method="post">
                            <input type="hidden" name="hidid" value="<%=customer.getCustID()%>"/>
                            <div class="row">
                              <div class="col-md-5 pr-md-1">
                                <div class="form-group">
                                  <label for="company" class="md-label-floating">Company (disabled)</label>
                                  <input type="text" class="form-control" disabled="" placeholder="Company" value="Veterinary Clinic">
                                </div>
                              </div>
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  <label for="id" class="md-label-floating">Customer ID</label>
                                  <input type="text" name="id" class="form-control" disabled="" id="id" value="<%=customer.getCustID()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="email" class="form-control" placeholder="123@gmail.com" value="<%=customer.getCustEmail()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Muhammad Ali Bin Abu" value="<%=customer.getCustName()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Age</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="age" class="form-control" placeholder="23" value="<%=customer.getCustAge()%>">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Gender</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <select class="selectpicker" name="gender" data-style="select-with-transition" title="Choose Gender" data-size="2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                   <input type="text" name="phone" class="form-control" placeholder="0123456789" value="<%=customer.getCustPhoneNo()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Password</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="password" class="form-control" placeholder="Password" value="<%=customer.getCustPassword()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Address</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="address" class="form-control" placeholder="Address" value="<%=customer.getCustAddress()%>">
                                </div>
                              </div>
                            </div>
