<%-- 
    Document   : process-update-staff1
    Created on : Mar 30, 2021, 10:37:09 PM
    Author     : cwrre
--%>
...
<%
        ...
        Staff staff = staffDao.retrieveOneStaff(staffID);
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body ">
                          <form role="form" action="../UpdateStaffServlet" method="post">
                            <input type="hidden" name="hidid" value="<%=staff.getStaffID()%>"/>
                            <div class="row">
                              ...
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  <label for="id" class="md-label-floating">Staff ID</label>
                                  <input type="text" class="form-control" disabled="" id="id" placeholder="id" value="<%=staff.getStaffID()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="email" class="form-control" placeholder="123@gmail.com" value="<%=staff.getStaffEmail()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Muhammad Ali Bin Abu" value="<%=staff.getStaffName()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                   <input type="text" name="phone" class="form-control" placeholder="0123456789" value="<%=staff.getStaffPhoneNo()%>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Password</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="password" class="form-control" placeholder="Password" value="<%=staff.getStaffPassword()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Address</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="address" class="form-control" placeholder="Address" value="<%=staff.getStaffAddress()%>">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Responsibility</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="responsibility" class="form-control" placeholder="Responsibility" value="<%=staff.getResponsibility()%>">
                                </div>
                              </div>
                            </div>
