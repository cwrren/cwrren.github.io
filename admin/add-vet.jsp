<%-- 
    Document   : add-vet1
    Created on : Mar 31, 2021, 10:29:52 PM
    Author     : cwrre
--%>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body ">
                          <form role="form" action="../AddVetServlet" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Responsibility</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                  <input type="text" name="responsibility" class="form-control" placeholder="Responsibility" value="">
                                </div>
                              </div>
                            </div>
