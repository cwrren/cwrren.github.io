<%-- 
    Document   : pet-list1
    Created on : Mar 30, 2021, 5:00:46 PM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.List, java.io.*"%>
<%@page import="java.sql.*, vetclinic.Pet, Customer.Customer, Customer.CustomerDAO"%>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Pets</a>
          </div>
                                ...
                                <tbody>
                                  <%
                                        for (int i = 0; i<allPet.size(); i++){
                                          ...
                                          out.println("<tr>");
                                          out.println("<td><img src='getPetImage.jsp?petID="+allPet.get(i).getPetID()+"' height='75'></td>");
                                          out.println("<td>"+allPet.get(i).getPetID() + "</td>");
                                          out.println("<td>"+allPet.get(i).getPetName()+"</td>");
                                          out.println("<td>"+allPet.get(i).getPetAge()+"</td>");
                                          out.println("<td>"+allPet.get(i).getSpecies()+"</td>");
                                          out.println("<td>"+allPet.get(i).getCustID()+" - "+customerDao.retrieveOneCustomer(allPet.get(i).getCustID()).getCustName()+"</td>");
                                          out.println("<td><a href=process-update-pet.jsp?medID="
                                                  + allPet.get(i).getPetID() + ">Update</a>"
                                                  + "i" + "<a href=../DeletePetServlet?medID="
                                                  + allPet.get(i).getPetID() + " onclick=\"return confirm"
                                  ...
                                  <tr>
                                    <td colspan="2" class="text-left">
                                        <a href="add-pet.jsp"><button type="button" class="btn btn-info btn-round">Add Pet <i class="material-icons">keyboard_arrow_right</i></button></a>
                                    </td>
                                  </tr>
                                </tbody>
                          </table>
