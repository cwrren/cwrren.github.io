<%-- 
    Document   : medicine-list
    Created on : Mar 29, 2021, 12:13:21 AM
    Author     : cwrre
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.List, java.text.DecimalFormat"%>
<%@page import="java.sql.*, vetclinic.Medicine"%>
<jsp:useBean id="database" class="vetclinic.DBConnection" scope="request"/>
<jsp:useBean id="medicineDao" class="vetclinic.MedicineDAO" scope="request"/>
<!DOCTYPE html>
<html lang="en">
...
<%
            ...
            List<Medicine> allMedicine = medicineDao.retrieveAllMedicine();
%>
                                ...
                                <tbody>
                                  <%
                                        ...
                                        for (int i = 0; i<allMedicine.size(); i++){
                                          ...
                                          out.println("<tr>");
                                          out.println("<td>"+allMedicine.get(i).getMedID() + "</td>");
                                          out.println("<td>"+allMedicine.get(i).getMedName()+"</td>");
                                          out.println("<td>"+allMedicine.get(i).getMedQuantity()+"</td>");
                                          out.println("<td>RM\t"+df.format(allMedicine.get(i).getMedPrice())+"</td>");
                                          out.println("<td>"+allMedicine.get(i).getMedExpiryDate()+"</td>");
                                          out.println("<td>"+allMedicine.get(i).getLastUpdate()+"</td>");
                                          out.println("<td><a href=process-update-medicine.jsp?medID="
                                                  + allMedicine.get(i).getMedID() + ">Update</a>"
                                                  + "i" + "<a href=../DeletMedicineServlet?medID="
                                                  + allMedicine.get(i).getMedID() + " onclick=\"return confirm"
                                  ...
                                  <tr>
                                    <td colspan="2" class="text-left">
                                        <a href="add-medicine.jsp"><button type="button" class="btn btn-info btn-round">Add Medicine <i class="material-icons">keyboard_arrow_right</i></button></a>
                                    </td>
                                  </tr>
                                </tbody>
                          </table>
