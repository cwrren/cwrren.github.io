<%-- 
    ...
    Created on : Mar 28, 2021, 3:03:16 PM
    Author     : cwrre
--%>
              ...
              <div class="row">
                  <div class="col-md-12">
                    <div class="card ">
                        ...
                        <div class="card-body ">
                          <form role="form" action="../AddCustomerServlet" method="post">
                            <div class="row">
                              ...
                              <div class="col-md-3 px-md-1">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" disabled="" id="id" placeholder="id" value="Auto Increment">
                                </div>
                              </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="email" class="form-control" placeholder="123@gmail.com" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Muhammad Ali Bin Abu" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                              <label class="col-sm-2 col-form-label">Age</label>
                                <div class="col-sm-10">
                                  <div class="form-group">
                                    <input type="text" name="age" class="form-control" placeholder="23" value="">
                                  </div>
                              </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  <div class="form-group">
                                   <input type="text" name="phone" class="form-control" placeholder="0123456789" value="">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                  ...
                                  <%
                                      for (int i = 0; i<allPet.size(); i++){
                                          out.println("<option value='"+allPet.get(i).getPetID()+"'>"+allPet.get(i).getPetID()+" "+allPet.get(i).getPetName()+"</option>");
                                      }
                                  %>
                                  </select>
                                </div>
