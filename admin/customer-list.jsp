<%--
    Document   : customer-list1
    Created on : Mar 28, 2021, 1:46:58 AM
    Author     : cwrre
--%>
...
<%@page import="java.sql.*, Customer.Customer"%>
                                ...
                                <tbody>
                                  <%
                                      for (int i = 0; i<allCustomer.size(); i++){
                                        ...
                                        out.println("<tr>");
                                        out.println("<td class='text-center'>"+allCustomer.get(i).getCustID() + "</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustName()+"</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustAge()+"</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustGender()+"</td>");
                                        out.println("<td> +60 "+allCustomer.get(i).getCustPhoneNo()+"</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustEmail()+"</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustPassword()+"</td>");
                                        out.println("<td>"+allCustomer.get(i).getCustAddress()+"</td>");
                                        out.println("<td class='td-actions text-right'><a href=process-update-customer.jsp?custID="
                                                + allCustomer.get(i).getCustID() + ">"
                                                + "<button type='button' data-toggle='tooltip' class='btn btn-success btn-round'><i class='material-icons'>edit</i></button></a>"
                                                + "i" + "<a href=../DeleteCustomerServlet?custID="
                                                + allCustomer.get(i).getCustID() + " onclick=\"return confirm"
                                                + "('Are you sure you want to delete?')\">"
                                                + "<button type='button' data-toggle='tooltip' class='btn btn-danger btn-round'><i class='material-icons'>close</i></button></a>"
                                                + "</td>");
                                        out.println("</tr>");
                                    }
                                  %>
                                  <tr>
                                    <td colspan="2" class="text-left">
                                        <a href="add-customer.jsp"><button type="button" class="btn btn-info btn-round">Add Customer <i class="material-icons">keyboard_arrow_right</i></button></a>
                                    </td>
                                  </tr>
                                </tbody>
                          </table>
